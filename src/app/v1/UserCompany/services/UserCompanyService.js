...
module.exports = {
	...
	async validateUserRegistrationType(tokenUserType, requestType) {
		let userType;
		const userEnum = UserEnum();
		tokenUserType === userEnum.type.superUser ?
			userType = validRequestType(requestType)
			:
			userType = userEnum.type.user;
